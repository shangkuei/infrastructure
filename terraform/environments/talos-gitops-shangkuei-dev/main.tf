# Talos GitOps Shangkuei Dev - Main Configuration
#
# This environment uses the talos-gitops module to bootstrap Flux CD
# on the shangkuei-dev Kubernetes cluster for GitOps-based continuous delivery.
...
# Talos GitOps Module
# ============================================================================
# This module bootstraps Flux CD on the shangkuei-dev Kubernetes cluster using:
