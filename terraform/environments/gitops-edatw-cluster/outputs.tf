...
output "deployment_phase" {
  ...
  value       = <<-EOT
    ╔════════════════════════════════════════════════════════════════════════════╗
    ║              EDATW GITOPS DEPLOYMENT GUIDE                                  ║
    ╚════════════════════════════════════════════════════════════════════════════╝

    This configuration deploys Flux CD on the edatw cluster.
    ...
    Full documentation: terraform/environments/gitops-edatw-cluster/README.md
  EOT
}
