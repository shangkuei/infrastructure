# Talos GitOps - Main Configuration
#
# This environment uses the talos-gitops module to bootstrap Flux CD
# on Talos Kubernetes clusters for GitOps-based continuous delivery.
#
# This serves as the reference implementation demonstrating module usage.
...
# Talos GitOps Module
# ============================================================================
# This module bootstraps Flux CD on Talos Kubernetes clusters using:
...
module "talos_gitops" {
  ...
  sops_age_key = file(var.sops_age_key_path)
