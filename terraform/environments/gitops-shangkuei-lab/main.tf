# Talos GitOps Shangkuei Lab - Main Configuration
#
# This environment uses the gitops module to bootstrap Flux CD
# on the shangkuei-lab Kubernetes cluster for GitOps-based continuous delivery.
...
# Talos GitOps Module
# ============================================================================
# This module bootstraps Flux CD on the shangkuei-lab Kubernetes cluster using:
