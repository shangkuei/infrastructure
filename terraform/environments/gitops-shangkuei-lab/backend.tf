# Terraform Backend Configuration - gitops-shangkuei-lab with SOPS Encryption
#
# This configuration stores Terraform state for Flux GitOps bootstrap on shangkuei-lab.
