...
output "deployment_phase" {
  ...
  value       = <<-EOT
    ╔════════════════════════════════════════════════════════════════════════════╗
    ║              SHANGKUEI-LAB GITOPS DEPLOYMENT GUIDE                          ║
    ╚════════════════════════════════════════════════════════════════════════════╝

    This configuration deploys Flux CD on the shangkuei-lab cluster.
    ...
    Full documentation: terraform/environments/gitops-shangkuei-lab/README.md
  EOT
}
