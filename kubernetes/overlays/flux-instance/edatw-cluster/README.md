...
- **Secrets managed via Kustomize** overlay for the edatw-cluster
- **Referenced by**: `kubernetes/clusters/edatw-cluster/kustomization-flux-instance.yaml`
...
- Age encryption key file (from `~/.config/sops/age/gitops-edatw-cluster-flux.txt`)
